...
public class FlightsTab extends TabBase 
{
	 ...
	 */
	public FlightsTab(FlightManager manager, ReservationManager rm) 
	{
	...
	private class MyListSelectionListener implements ListSelectionListener 
	{
		...
		public void valueChanged(ListSelectionEvent event) {
			try {
				...
				tAirline.setText(f.getAirlineName());
		...
		public void actionPerformed(ActionEvent event) {
			...
			if ( event.getSource() == reserve ) {
				try {
					...
					rm.makeReservation(manager.findFlightByCode(tFlight.getText()),tName.getText(),tCitizenship.getText()).getCode());
					emptyFields();
					clearList();
					fillList();
